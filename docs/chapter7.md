...
統合を実行するには通常、事前に ***アクティブ化*** という操作が必要ですが、REST アダプタ・トリガーを使用している統合は、 ワン・クリックでシームレスに動作確認が可能です。
...
![スクリーンショット: 「エラー」パネル](./images/canvas_error.png)
...
1.  統合キャンバスの右上部にある **「ビジネス識別子」** をクリックします。
    ...
    ![スクリーンショット: 「ビジネス識別子」をクリック](./images/business_identifier_button.png)
...
アクティビティ・ストリームの確認したら、 **「テストの終了」** をクリックします。
