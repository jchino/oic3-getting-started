...
この章では、Oracle Cloud コンソールから Oracle Integration のサービス・コンソールへアクセスする手順を確認します。
...
2.  Oracle Cloud コンソールのナビゲーション・メニューで **「開発者サービス」** → **「アプリケーション統合」** → **「統合」** を選択します。
...
この章では、Oracle Cloud コンソールから Oracle Integration のサービス・コンソールへアクセスする手順を確認しました。
