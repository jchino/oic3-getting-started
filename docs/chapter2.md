...
4.  このチュートリアルで使用する Oracle Integration のサービス・インスタンスの右側にある **「アクション・メニュー」** をクリックし、**「コンソールを開く」** を選択します。
    ...
    ![スクリーンショット: Oracle Integration サービス・インスタンス一覧](./images/oic_instances.png)

## 2.3 サービス・コンソールの画面構成

サービス・コンソールの左上にある **「ナビゲーション・メニュー」** から、Oracle Integration のさまざまな機能へアクセスできます。

![スクリーンショット: Oracle Integration サービス・コンソール](./images/service_console.png)
...
以降の章では、主に ***プロジェクト (Project)*** を使用して作業を進めます。
