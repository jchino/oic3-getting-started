...
Oracle Integration では、以下のような情報を確認できます。
...
これらの情報を活用することで、問題の特定や動作確認を行うことができます。
...
3.  **「インスタンス」** を選択します。
    ...
    ![スクリーンショット: インスタンス一覧](./images/instances_list.png)

4.  インスタンスの **「詳細の表示」** ボタンをクリックすると、詳細情報にドリルダウンできます。
    ![スクリーンショット: インスタンス詳細画面](./images/instance_detail.png)
...
本チュートリアルの『[7. 統合のテスト](chapter7.md)』で紹介した、Integration Canvas からのテスト実行時は、このデバッグ・レベルが使用されます。
...
この章では、Oracle Intgration のモニタリング機能を使用して、統合の実行結果を確認する方法を学びました。
