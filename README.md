...
本チュートリアルでは、Oracle Integration を使用して以下の処理を実装しながら、基本的な使い方を学びます。
...
実務的な内容（例外処理・スケジュール）はオプションとして後半で扱います。

## 👤 対象読者

- Oracle Integration をこれから利用する開発者
- 基本的なプログラミング知識（条件分岐・ループなど）を持つ方が前提
...
3. 結果を CSV ファイルとして生成
4. FTP Adapter でファイルを SFTP サーバーへアップロード
